...
export default function Profile() {
  ...
  return (
    <>
      <Navbar />
      <div className="max-w-lg mt-6 mx-auto p-6 bg-white shadow-md rounded-md space-y-6">
        <h1 className="text-2xl font-bold text-center">Moj profil</h1>
          ...
          <form onSubmit={handleAccountSubmit} className="space-y-4">
            ...
            <div>
              ...
              <select
                ...
                className="w-full border rounded p-2"
              >
                <option value="">Izberi vrsto zaposlitve</option>
        ...
        {changingPassword && (
          <form onSubmit={handlePasswordSubmit} className="space-y-4">
            <div>
              <label htmlFor="currentPassword" className="block text-sm font-medium text-gray-700">Trenutno geslo</label>
              <input
                id="currentPassword"
                type="password"
            ...
            <div>
              <label htmlFor="newPassword" className="block text-sm font-medium text-gray-700">Novo geslo</label>
              <input
                id="newPassword"
                type="password"
                name="newPassword"
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-sm font-medium text-gray-700">Potrdi novo geslo</label>
              <input
                id="confirmPassword"
                type="password"
